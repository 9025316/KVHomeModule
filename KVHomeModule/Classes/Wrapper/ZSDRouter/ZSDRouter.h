...
@interface ZSDRouter : NSObject
/// 存储路由，moduleID信息，权限配置信息
@property (nonatomic, strong, readonly) NSMutableSet <NSDictionary *>* modules;
/// App的最顶部的控制器
...
/**
 ...
 + (instancetype)zsdRouterViewControllerWithJSON:(NSDictionary *)dic 这个方法的重写。
 @param targetClassName 跳转的target类名
 @param options 跳转的各种设置
